#ifndef SPIRAL_QPID_REFCOUNTED_H
#define SPIRAL_QPID_REFCOUNTED_H
...
namespace boost {
inline void intrusive_ptr_add_ref(const spiral::RefCounted* p) { p->addRef(); }
inline void intrusive_ptr_release(const spiral::RefCounted* p) { p->release(); }
}


#endif  /*!SPIRAL_QPID_REFCOUNTED_H*/
