#ifndef SPIRAL_QPID_COMMONOPTIONS_H
#define SPIRAL_QPID_COMMONOPTIONS_H
...
struct Options : public po::options_description {
    ...
    struct Exception : public spiral::Exception {
        Exception(const std::string& msg) : spiral::Exception(msg) {}
    };
...
#endif  /*!SPIRAL_QPID_COMMONOPTIONS_H*/
