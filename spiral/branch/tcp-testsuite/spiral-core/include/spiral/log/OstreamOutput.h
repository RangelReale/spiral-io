#ifndef SPIRAL_QPID_LOG_OSTREAMOUTPUT_H
#define SPIRAL_QPID_LOG_OSTREAMOUTPUT_H
 ...
 * ostream.
 */
class OstreamOutput : public spiral::log::Logger::Output {
public:
...
#endif /*!SPIRAL_QPID_LOG_OSTREAMOUTPUT_H*/
